...
int main()
{
    int tCase,nCase;
    cin>>tCase;
    double cm=12.01,hm=1.008,om=16.00,nm=14.01;
    getchar();
    fr(nCase,1,tCase)
    {
        int i;
        ...
        {
            temp=n[i];
            //cout<<"ch = "<<ch<<" temp = "<<temp<<" tempN = "<<tempN<<endl;
            if(temp>='0' && temp<='9')
            {
                tempN=tempN*10;
                tempN+=(temp-'0');
            }
            else if(temp=='C'||temp=='O'||temp=='H'||temp=='N')
            {
                if(tempN==0)
                {
                    arr[ch]+=1;
        ...
        //cout<<"C ="<<arr['C']<<" H = "<<arr['H']<<" O = "<<arr['O']<<" N = "<<arr['N']<<endl;
        double ans =0;
        ans += (double)(arr['C'])*cm;
        ans += (double)(arr['H'])*hm;
        ans += (double)(arr['O'])*om;
