...
vector<char>V;
long long int convertIntoDecimal(string n,long long int base)
{
    long long sum=0;
...
void convertIntoGivenBase(long long n,long long base)
{
    string temp;
    temp.clear();
...
int main()
{
    ...
    while(cin>>base1>>base2)
    {
        getchar();
        getline(cin,str);
        //cout<<base1<<" "<<base2<<" "<<str<<endl;
        //getchar();
        if(base2==10)
        {
            long long ans=convertIntoDecimal(str,base1);
            //cout<<ans<<endl;
            if(ans!=-1)
            {
                //10101 base 2 = 21 base 10
                cout<<str<<" base "<<base1<<" = "<<ans<<" base 10"<<endl;
            }
            else
            {
                cout<<str;
        ...
        else
        {
            long long ans=convertIntoDecimal(str,base1);
            if(ans==0)
                cout<<str<<" base "<<base1<<" = "<<0<<" base "<<base2<<endl;
            else if(ans>0 )
            {
                int k;
                V.clear();
                convertIntoGivenBase(ans,base2);
                cout<<str<<" base "<<base1<<" = ";
                int xxx=V.size();
                xxx--;
                frn(k,xxx,0)
